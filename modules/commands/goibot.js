...
module.exports.handleEvent = function({ api, event }) {
  ...
  var tl = ["chào bạn tôi là bot của phú", "bạn gọi tôi có việc gì?", "tôi yêu bạn vai lon", "Yêu em <3", "Hi, chào con vợ bé:3", "Vợ gọi có việc gì không?", "Sử dụng callad để liên lạc với admin!", "Em là bot cute nhất hành tinh", "Nói gì thế con lợn", "Em đây~~~~", "Yêu anh phú nhất","Yêu thương admin nhất", "Gọi tao lm gì sủa lẹ", "Sao thế công chúa", "Đừng làm em đau ~~~~ hic :(", "Yêu em ❤", "Tuyển phi công nè ạ", "Làm bồ em ko ạ? dui lắm", "Cậu cô đơn ko?", "Tuyển ghệ đút bự đi bay lắc", "Được của ló :)))", "Em dthw như chủ của em ạ", "Đừng khen em ngại quá hí hí" ,"Làm chồng em ko ạ?", "Đừng spam em nha :<<", "Cút ra", "Bằng láu hủ tiếu kinh nghiêm đầy minh tuyển ghệ đít bự", "Trẩu spam", "Omg yêu mọi người ❤", "Spam cc cút", "Yêu em ko?", "Chồng em đây rồi"];
